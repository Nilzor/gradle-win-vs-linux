...
public class ABBF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABBF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABBFB());
        mChildren.add(new ABBFC());
        mChildren.add(new ABBFD());
        mChildren.add(new ABBFE());
        mChildren.add(new ABBFF());
