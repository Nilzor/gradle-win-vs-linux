...
public class AECC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AECC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AECCB());
        mChildren.add(new AECCC());
        mChildren.add(new AECCD());
        mChildren.add(new AECCE());
        mChildren.add(new AECCF());
