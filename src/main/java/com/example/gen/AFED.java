...
public class AFED implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFED() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFEDB());
        mChildren.add(new AFEDC());
        mChildren.add(new AFEDD());
        mChildren.add(new AFEDE());
        mChildren.add(new AFEDF());
