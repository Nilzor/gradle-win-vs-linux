...
public class ABE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABEB());
        mChildren.add(new ABEC());
        mChildren.add(new ABED());
        mChildren.add(new ABEE());
        mChildren.add(new ABEF());
