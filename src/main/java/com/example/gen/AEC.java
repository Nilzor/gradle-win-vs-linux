...
public class AEC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AEC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AECB());
        mChildren.add(new AECC());
        mChildren.add(new AECD());
        mChildren.add(new AECE());
        mChildren.add(new AECF());
