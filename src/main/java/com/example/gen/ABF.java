...
public class ABF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABFB());
        mChildren.add(new ABFC());
        mChildren.add(new ABFD());
        mChildren.add(new ABFE());
        mChildren.add(new ABFF());
