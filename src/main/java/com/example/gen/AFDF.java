...
public class AFDF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFDF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFDFB());
        mChildren.add(new AFDFC());
        mChildren.add(new AFDFD());
        mChildren.add(new AFDFE());
        mChildren.add(new AFDFF());
