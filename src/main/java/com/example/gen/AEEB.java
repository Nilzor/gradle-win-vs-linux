...
public class AEEB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AEEB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AEEBB());
        mChildren.add(new AEEBC());
        mChildren.add(new AEEBD());
        mChildren.add(new AEEBE());
        mChildren.add(new AEEBF());
