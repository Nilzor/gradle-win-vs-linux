...
public class AEDC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AEDC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AEDCB());
        mChildren.add(new AEDCC());
        mChildren.add(new AEDCD());
        mChildren.add(new AEDCE());
        mChildren.add(new AEDCF());
