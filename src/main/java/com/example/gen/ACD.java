...
public class ACD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACDB());
        mChildren.add(new ACDC());
        mChildren.add(new ACDD());
        mChildren.add(new ACDE());
        mChildren.add(new ACDF());
