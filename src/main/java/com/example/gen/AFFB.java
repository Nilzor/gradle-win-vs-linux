...
public class AFFB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFFB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFFBB());
        mChildren.add(new AFFBC());
        mChildren.add(new AFFBD());
        mChildren.add(new AFFBE());
        mChildren.add(new AFFBF());
