...
public class ABDF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABDF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABDFB());
        mChildren.add(new ABDFC());
        mChildren.add(new ABDFD());
        mChildren.add(new ABDFE());
        mChildren.add(new ABDFF());
