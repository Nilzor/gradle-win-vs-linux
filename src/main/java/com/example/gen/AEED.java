...
public class AEED implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AEED() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AEEDB());
        mChildren.add(new AEEDC());
        mChildren.add(new AEEDD());
        mChildren.add(new AEEDE());
        mChildren.add(new AEEDF());
