...
public class ADCC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADCC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADCCB());
        mChildren.add(new ADCCC());
        mChildren.add(new ADCCD());
        mChildren.add(new ADCCE());
        mChildren.add(new ADCCF());
