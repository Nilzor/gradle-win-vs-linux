...
public class AFEB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFEB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFEBB());
        mChildren.add(new AFEBC());
        mChildren.add(new AFEBD());
        mChildren.add(new AFEBE());
        mChildren.add(new AFEBF());
