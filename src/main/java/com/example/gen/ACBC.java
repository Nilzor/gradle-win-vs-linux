...
public class ACBC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACBC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACBCB());
        mChildren.add(new ACBCC());
        mChildren.add(new ACBCD());
        mChildren.add(new ACBCE());
        mChildren.add(new ACBCF());
