...
public class ACDB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACDB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACDBB());
        mChildren.add(new ACDBC());
        mChildren.add(new ACDBD());
        mChildren.add(new ACDBE());
        mChildren.add(new ACDBF());
