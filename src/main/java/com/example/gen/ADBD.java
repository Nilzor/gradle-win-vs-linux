...
public class ADBD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADBD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADBDB());
        mChildren.add(new ADBDC());
        mChildren.add(new ADBDD());
        mChildren.add(new ADBDE());
        mChildren.add(new ADBDF());
