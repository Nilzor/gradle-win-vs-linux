...
public class AFB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFBB());
        mChildren.add(new AFBC());
        mChildren.add(new AFBD());
        mChildren.add(new AFBE());
        mChildren.add(new AFBF());
