...
public class AEB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AEB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AEBB());
        mChildren.add(new AEBC());
        mChildren.add(new AEBD());
        mChildren.add(new AEBE());
        mChildren.add(new AEBF());
