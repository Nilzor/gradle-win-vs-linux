...
public class AFFD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFFD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFFDB());
        mChildren.add(new AFFDC());
        mChildren.add(new AFFDD());
        mChildren.add(new AFFDE());
        mChildren.add(new AFFDF());
