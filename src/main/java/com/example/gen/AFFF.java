...
public class AFFF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFFF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFFFB());
        mChildren.add(new AFFFC());
        mChildren.add(new AFFFD());
        mChildren.add(new AFFFE());
        mChildren.add(new AFFFF());
