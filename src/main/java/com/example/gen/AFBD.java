...
public class AFBD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFBD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFBDB());
        mChildren.add(new AFBDC());
        mChildren.add(new AFBDD());
        mChildren.add(new AFBDE());
        mChildren.add(new AFBDF());
