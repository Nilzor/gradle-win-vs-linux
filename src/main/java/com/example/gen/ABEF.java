...
public class ABEF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABEF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABEFB());
        mChildren.add(new ABEFC());
        mChildren.add(new ABEFD());
        mChildren.add(new ABEFE());
        mChildren.add(new ABEFF());
