...
public class ADD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADDB());
        mChildren.add(new ADDC());
        mChildren.add(new ADDD());
        mChildren.add(new ADDE());
        mChildren.add(new ADDF());
