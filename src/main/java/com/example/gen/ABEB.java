...
public class ABEB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABEB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABEBB());
        mChildren.add(new ABEBC());
        mChildren.add(new ABEBD());
        mChildren.add(new ABEBE());
        mChildren.add(new ABEBF());
