...
public class ACDC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACDC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACDCB());
        mChildren.add(new ACDCC());
        mChildren.add(new ACDCD());
        mChildren.add(new ACDCE());
        mChildren.add(new ACDCF());
