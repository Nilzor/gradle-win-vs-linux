...
public class ACFC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACFC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACFCB());
        mChildren.add(new ACFCC());
        mChildren.add(new ACFCD());
        mChildren.add(new ACFCE());
        mChildren.add(new ACFCF());
