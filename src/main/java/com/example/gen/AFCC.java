...
public class AFCC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFCC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFCCB());
        mChildren.add(new AFCCC());
        mChildren.add(new AFCCD());
        mChildren.add(new AFCCE());
        mChildren.add(new AFCCF());
