...
public class ADFF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADFF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADFFB());
        mChildren.add(new ADFFC());
        mChildren.add(new ADFFD());
        mChildren.add(new ADFFE());
        mChildren.add(new ADFFF());
