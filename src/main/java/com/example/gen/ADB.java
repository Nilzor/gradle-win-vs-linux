...
public class ADB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADBB());
        mChildren.add(new ADBC());
        mChildren.add(new ADBD());
        mChildren.add(new ADBE());
        mChildren.add(new ADBF());
