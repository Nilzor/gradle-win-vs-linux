...
public class AECF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AECF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AECFB());
        mChildren.add(new AECFC());
        mChildren.add(new AECFD());
        mChildren.add(new AECFE());
        mChildren.add(new AECFF());
