...
public class ACCF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACCF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACCFB());
        mChildren.add(new ACCFC());
        mChildren.add(new ACCFD());
        mChildren.add(new ACCFE());
        mChildren.add(new ACCFF());
