...
public class ACCE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACCE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACCEB());
        mChildren.add(new ACCEC());
        mChildren.add(new ACCED());
        mChildren.add(new ACCEE());
        mChildren.add(new ACCEF());
