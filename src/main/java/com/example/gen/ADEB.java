...
public class ADEB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADEB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADEBB());
        mChildren.add(new ADEBC());
        mChildren.add(new ADEBD());
        mChildren.add(new ADEBE());
        mChildren.add(new ADEBF());
