...
public class ACCC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACCC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACCCB());
        mChildren.add(new ACCCC());
        mChildren.add(new ACCCD());
        mChildren.add(new ACCCE());
        mChildren.add(new ACCCF());
