...
public class ACBD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACBD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACBDB());
        mChildren.add(new ACBDC());
        mChildren.add(new ACBDD());
        mChildren.add(new ACBDE());
        mChildren.add(new ACBDF());
