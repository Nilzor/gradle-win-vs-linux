...
public class AFBF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFBF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFBFB());
        mChildren.add(new AFBFC());
        mChildren.add(new AFBFD());
        mChildren.add(new AFBFE());
        mChildren.add(new AFBFF());
