...
public class ADFC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADFC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADFCB());
        mChildren.add(new ADFCC());
        mChildren.add(new ADFCD());
        mChildren.add(new ADFCE());
        mChildren.add(new ADFCF());
