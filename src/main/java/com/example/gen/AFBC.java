...
public class AFBC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFBC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFBCB());
        mChildren.add(new AFBCC());
        mChildren.add(new AFBCD());
        mChildren.add(new AFBCE());
        mChildren.add(new AFBCF());
