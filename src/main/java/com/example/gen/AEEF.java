...
public class AEEF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AEEF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AEEFB());
        mChildren.add(new AEEFC());
        mChildren.add(new AEEFD());
        mChildren.add(new AEEFE());
        mChildren.add(new AEEFF());
