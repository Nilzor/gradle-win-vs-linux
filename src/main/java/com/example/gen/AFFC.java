...
public class AFFC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFFC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFFCB());
        mChildren.add(new AFFCC());
        mChildren.add(new AFFCD());
        mChildren.add(new AFFCE());
        mChildren.add(new AFFCF());
