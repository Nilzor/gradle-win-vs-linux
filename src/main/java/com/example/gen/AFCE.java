...
public class AFCE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFCE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFCEB());
        mChildren.add(new AFCEC());
        mChildren.add(new AFCED());
        mChildren.add(new AFCEE());
        mChildren.add(new AFCEF());
