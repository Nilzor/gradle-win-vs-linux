...
public class AEBD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AEBD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AEBDB());
        mChildren.add(new AEBDC());
        mChildren.add(new AEBDD());
        mChildren.add(new AEBDE());
        mChildren.add(new AEBDF());
