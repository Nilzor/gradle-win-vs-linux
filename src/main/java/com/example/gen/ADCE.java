...
public class ADCE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADCE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADCEB());
        mChildren.add(new ADCEC());
        mChildren.add(new ADCED());
        mChildren.add(new ADCEE());
        mChildren.add(new ADCEF());
