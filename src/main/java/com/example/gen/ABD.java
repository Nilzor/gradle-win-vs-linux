...
public class ABD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABDB());
        mChildren.add(new ABDC());
        mChildren.add(new ABDD());
        mChildren.add(new ABDE());
        mChildren.add(new ABDF());
