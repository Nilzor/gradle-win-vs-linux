...
public class ABFB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABFB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABFBB());
        mChildren.add(new ABFBC());
        mChildren.add(new ABFBD());
        mChildren.add(new ABFBE());
        mChildren.add(new ABFBF());
