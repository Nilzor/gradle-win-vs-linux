...
public class ADBC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADBC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADBCB());
        mChildren.add(new ADBCC());
        mChildren.add(new ADBCD());
        mChildren.add(new ADBCE());
        mChildren.add(new ADBCF());
