...
public class ABBD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABBD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABBDB());
        mChildren.add(new ABBDC());
        mChildren.add(new ABBDD());
        mChildren.add(new ABBDE());
        mChildren.add(new ABBDF());
