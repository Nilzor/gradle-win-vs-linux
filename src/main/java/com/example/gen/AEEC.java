...
public class AEEC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AEEC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AEECB());
        mChildren.add(new AEECC());
        mChildren.add(new AEECD());
        mChildren.add(new AEECE());
        mChildren.add(new AEECF());
