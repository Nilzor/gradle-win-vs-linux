...
public class ABBC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABBC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABBCB());
        mChildren.add(new ABBCC());
        mChildren.add(new ABBCD());
        mChildren.add(new ABBCE());
        mChildren.add(new ABBCF());
