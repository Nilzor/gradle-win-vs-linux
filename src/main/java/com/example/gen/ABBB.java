...
public class ABBB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABBB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABBBB());
        mChildren.add(new ABBBC());
        mChildren.add(new ABBBD());
        mChildren.add(new ABBBE());
        mChildren.add(new ABBBF());
