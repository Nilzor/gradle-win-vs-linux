...
public class ADDD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADDD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADDDB());
        mChildren.add(new ADDDC());
        mChildren.add(new ADDDD());
        mChildren.add(new ADDDE());
        mChildren.add(new ADDDF());
