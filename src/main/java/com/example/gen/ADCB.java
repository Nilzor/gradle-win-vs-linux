...
public class ADCB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADCB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADCBB());
        mChildren.add(new ADCBC());
        mChildren.add(new ADCBD());
        mChildren.add(new ADCBE());
        mChildren.add(new ADCBF());
