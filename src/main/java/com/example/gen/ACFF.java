...
public class ACFF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACFF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACFFB());
        mChildren.add(new ACFFC());
        mChildren.add(new ACFFD());
        mChildren.add(new ACFFE());
        mChildren.add(new ACFFF());
