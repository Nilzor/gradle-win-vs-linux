...
public class ABFF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABFF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABFFB());
        mChildren.add(new ABFFC());
        mChildren.add(new ABFFD());
        mChildren.add(new ABFFE());
        mChildren.add(new ABFFF());
