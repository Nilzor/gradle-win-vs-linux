...
public class ACF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACFB());
        mChildren.add(new ACFC());
        mChildren.add(new ACFD());
        mChildren.add(new ACFE());
        mChildren.add(new ACFF());
