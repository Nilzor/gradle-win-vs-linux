...
public class AEFD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AEFD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AEFDB());
        mChildren.add(new AEFDC());
        mChildren.add(new AEFDD());
        mChildren.add(new AEFDE());
        mChildren.add(new AEFDF());
