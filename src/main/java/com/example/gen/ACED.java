...
public class ACED implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACED() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACEDB());
        mChildren.add(new ACEDC());
        mChildren.add(new ACEDD());
        mChildren.add(new ACEDE());
        mChildren.add(new ACEDF());
