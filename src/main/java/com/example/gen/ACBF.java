...
public class ACBF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACBF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACBFB());
        mChildren.add(new ACBFC());
        mChildren.add(new ACBFD());
        mChildren.add(new ACBFE());
        mChildren.add(new ACBFF());
