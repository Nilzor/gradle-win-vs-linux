...
public class ABFC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABFC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABFCB());
        mChildren.add(new ABFCC());
        mChildren.add(new ABFCD());
        mChildren.add(new ABFCE());
        mChildren.add(new ABFCF());
