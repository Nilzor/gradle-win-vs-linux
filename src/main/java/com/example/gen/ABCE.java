...
public class ABCE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABCE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABCEB());
        mChildren.add(new ABCEC());
        mChildren.add(new ABCED());
        mChildren.add(new ABCEE());
        mChildren.add(new ABCEF());
