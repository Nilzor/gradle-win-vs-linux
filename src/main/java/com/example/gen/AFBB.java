...
public class AFBB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFBB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFBBB());
        mChildren.add(new AFBBC());
        mChildren.add(new AFBBD());
        mChildren.add(new AFBBE());
        mChildren.add(new AFBBF());
