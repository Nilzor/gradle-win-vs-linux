...
public class AED implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AED() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AEDB());
        mChildren.add(new AEDC());
        mChildren.add(new AEDD());
        mChildren.add(new AEDE());
        mChildren.add(new AEDF());
