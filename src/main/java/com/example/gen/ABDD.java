...
public class ABDD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABDD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABDDB());
        mChildren.add(new ABDDC());
        mChildren.add(new ABDDD());
        mChildren.add(new ABDDE());
        mChildren.add(new ABDDF());
