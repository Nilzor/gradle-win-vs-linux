...
public class ACC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACCB());
        mChildren.add(new ACCC());
        mChildren.add(new ACCD());
        mChildren.add(new ACCE());
        mChildren.add(new ACCF());
