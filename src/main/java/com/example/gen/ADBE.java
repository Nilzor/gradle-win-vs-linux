...
public class ADBE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADBE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADBEB());
        mChildren.add(new ADBEC());
        mChildren.add(new ADBED());
        mChildren.add(new ADBEE());
        mChildren.add(new ADBEF());
