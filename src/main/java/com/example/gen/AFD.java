...
public class AFD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFDB());
        mChildren.add(new AFDC());
        mChildren.add(new AFDD());
        mChildren.add(new AFDE());
        mChildren.add(new AFDF());
