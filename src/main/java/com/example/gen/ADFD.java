...
public class ADFD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADFD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADFDB());
        mChildren.add(new ADFDC());
        mChildren.add(new ADFDD());
        mChildren.add(new ADFDE());
        mChildren.add(new ADFDF());
