...
public class ADC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADCB());
        mChildren.add(new ADCC());
        mChildren.add(new ADCD());
        mChildren.add(new ADCE());
        mChildren.add(new ADCF());
