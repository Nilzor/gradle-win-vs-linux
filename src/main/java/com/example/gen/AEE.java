...
public class AEE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AEE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AEEB());
        mChildren.add(new AEEC());
        mChildren.add(new AEED());
        mChildren.add(new AEEE());
        mChildren.add(new AEEF());
