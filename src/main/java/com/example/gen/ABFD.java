...
public class ABFD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABFD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABFDB());
        mChildren.add(new ABFDC());
        mChildren.add(new ABFDD());
        mChildren.add(new ABFDE());
        mChildren.add(new ABFDF());
