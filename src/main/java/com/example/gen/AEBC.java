...
public class AEBC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AEBC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AEBCB());
        mChildren.add(new AEBCC());
        mChildren.add(new AEBCD());
        mChildren.add(new AEBCE());
        mChildren.add(new AEBCF());
