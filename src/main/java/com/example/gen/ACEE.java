...
public class ACEE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACEE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACEEB());
        mChildren.add(new ACEEC());
        mChildren.add(new ACEED());
        mChildren.add(new ACEEE());
        mChildren.add(new ACEEF());
