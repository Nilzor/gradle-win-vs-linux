...
public class ADBB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADBB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADBBB());
        mChildren.add(new ADBBC());
        mChildren.add(new ADBBD());
        mChildren.add(new ADBBE());
        mChildren.add(new ADBBF());
