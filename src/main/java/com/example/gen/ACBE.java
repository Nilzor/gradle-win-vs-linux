...
public class ACBE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACBE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACBEB());
        mChildren.add(new ACBEC());
        mChildren.add(new ACBED());
        mChildren.add(new ACBEE());
        mChildren.add(new ACBEF());
