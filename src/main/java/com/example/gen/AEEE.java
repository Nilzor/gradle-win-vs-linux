...
public class AEEE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AEEE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AEEEB());
        mChildren.add(new AEEEC());
        mChildren.add(new AEEED());
        mChildren.add(new AEEEE());
        mChildren.add(new AEEEF());
