...
public class ACFD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACFD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACFDB());
        mChildren.add(new ACFDC());
        mChildren.add(new ACFDD());
        mChildren.add(new ACFDE());
        mChildren.add(new ACFDF());
