...
public class ACFB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACFB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACFBB());
        mChildren.add(new ACFBC());
        mChildren.add(new ACFBD());
        mChildren.add(new ACFBE());
        mChildren.add(new ACFBF());
