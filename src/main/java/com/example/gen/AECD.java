...
public class AECD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AECD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AECDB());
        mChildren.add(new AECDC());
        mChildren.add(new AECDD());
        mChildren.add(new AECDE());
        mChildren.add(new AECDF());
