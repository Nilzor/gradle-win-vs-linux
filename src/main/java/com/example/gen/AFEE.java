...
public class AFEE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFEE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFEEB());
        mChildren.add(new AFEEC());
        mChildren.add(new AFEED());
        mChildren.add(new AFEEE());
        mChildren.add(new AFEEF());
