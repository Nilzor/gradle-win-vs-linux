...
public class ACCD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACCD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACCDB());
        mChildren.add(new ACCDC());
        mChildren.add(new ACCDD());
        mChildren.add(new ACCDE());
        mChildren.add(new ACCDF());
