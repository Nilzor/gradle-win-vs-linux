...
public class ADEF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADEF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADEFB());
        mChildren.add(new ADEFC());
        mChildren.add(new ADEFD());
        mChildren.add(new ADEFE());
        mChildren.add(new ADEFF());
