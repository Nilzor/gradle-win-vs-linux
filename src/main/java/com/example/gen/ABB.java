...
public class ABB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABBB());
        mChildren.add(new ABBC());
        mChildren.add(new ABBD());
        mChildren.add(new ABBE());
        mChildren.add(new ABBF());
