...
public class ABBE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABBE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABBEB());
        mChildren.add(new ABBEC());
        mChildren.add(new ABBED());
        mChildren.add(new ABBEE());
        mChildren.add(new ABBEF());
