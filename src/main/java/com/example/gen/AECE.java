...
public class AECE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AECE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AECEB());
        mChildren.add(new AECEC());
        mChildren.add(new AECED());
        mChildren.add(new AECEE());
        mChildren.add(new AECEF());
