...
public class AFCF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFCF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFCFB());
        mChildren.add(new AFCFC());
        mChildren.add(new AFCFD());
        mChildren.add(new AFCFE());
        mChildren.add(new AFCFF());
