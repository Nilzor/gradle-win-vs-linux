...
public class AEDD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AEDD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AEDDB());
        mChildren.add(new AEDDC());
        mChildren.add(new AEDDD());
        mChildren.add(new AEDDE());
        mChildren.add(new AEDDF());
