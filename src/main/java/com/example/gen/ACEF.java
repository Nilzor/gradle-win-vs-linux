...
public class ACEF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACEF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACEFB());
        mChildren.add(new ACEFC());
        mChildren.add(new ACEFD());
        mChildren.add(new ACEFE());
        mChildren.add(new ACEFF());
