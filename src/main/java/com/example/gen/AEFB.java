...
public class AEFB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AEFB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AEFBB());
        mChildren.add(new AEFBC());
        mChildren.add(new AEFBD());
        mChildren.add(new AEFBE());
        mChildren.add(new AEFBF());
