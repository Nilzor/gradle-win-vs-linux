...
public class ADFE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADFE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADFEB());
        mChildren.add(new ADFEC());
        mChildren.add(new ADFED());
        mChildren.add(new ADFEE());
        mChildren.add(new ADFEF());
