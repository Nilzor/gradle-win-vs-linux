...
public class ABDC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABDC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABDCB());
        mChildren.add(new ABDCC());
        mChildren.add(new ABDCD());
        mChildren.add(new ABDCE());
        mChildren.add(new ABDCF());
