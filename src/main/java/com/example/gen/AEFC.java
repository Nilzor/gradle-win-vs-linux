...
public class AEFC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AEFC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AEFCB());
        mChildren.add(new AEFCC());
        mChildren.add(new AEFCD());
        mChildren.add(new AEFCE());
        mChildren.add(new AEFCF());
