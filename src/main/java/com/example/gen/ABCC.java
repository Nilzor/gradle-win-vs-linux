...
public class ABCC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABCC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABCCB());
        mChildren.add(new ABCCC());
        mChildren.add(new ABCCD());
        mChildren.add(new ABCCE());
        mChildren.add(new ABCCF());
