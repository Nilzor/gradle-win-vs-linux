...
public class ABEE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABEE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABEEB());
        mChildren.add(new ABEEC());
        mChildren.add(new ABEED());
        mChildren.add(new ABEEE());
        mChildren.add(new ABEEF());
