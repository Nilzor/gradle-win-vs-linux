...
public class ADBF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADBF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADBFB());
        mChildren.add(new ADBFC());
        mChildren.add(new ADBFD());
        mChildren.add(new ADBFE());
        mChildren.add(new ADBFF());
