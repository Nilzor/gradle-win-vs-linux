...
public class AFE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFEB());
        mChildren.add(new AFEC());
        mChildren.add(new AFED());
        mChildren.add(new AFEE());
        mChildren.add(new AFEF());
