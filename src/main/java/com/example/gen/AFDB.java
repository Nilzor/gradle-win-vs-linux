...
public class AFDB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFDB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFDBB());
        mChildren.add(new AFDBC());
        mChildren.add(new AFDBD());
        mChildren.add(new AFDBE());
        mChildren.add(new AFDBF());
