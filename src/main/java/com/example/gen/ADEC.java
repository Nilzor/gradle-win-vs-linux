...
public class ADEC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADEC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADECB());
        mChildren.add(new ADECC());
        mChildren.add(new ADECD());
        mChildren.add(new ADECE());
        mChildren.add(new ADECF());
