...
public class AFCD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFCD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFCDB());
        mChildren.add(new AFCDC());
        mChildren.add(new AFCDD());
        mChildren.add(new AFCDE());
        mChildren.add(new AFCDF());
