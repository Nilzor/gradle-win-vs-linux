...
public class ABCF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABCF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABCFB());
        mChildren.add(new ABCFC());
        mChildren.add(new ABCFD());
        mChildren.add(new ABCFE());
        mChildren.add(new ABCFF());
