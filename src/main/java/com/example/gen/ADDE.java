...
public class ADDE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADDE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADDEB());
        mChildren.add(new ADDEC());
        mChildren.add(new ADDED());
        mChildren.add(new ADDEE());
        mChildren.add(new ADDEF());
