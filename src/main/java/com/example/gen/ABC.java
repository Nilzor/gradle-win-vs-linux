...
public class ABC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABCB());
        mChildren.add(new ABCC());
        mChildren.add(new ABCD());
        mChildren.add(new ABCE());
        mChildren.add(new ABCF());
