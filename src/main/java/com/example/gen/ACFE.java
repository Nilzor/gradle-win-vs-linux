...
public class ACFE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACFE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACFEB());
        mChildren.add(new ACFEC());
        mChildren.add(new ACFED());
        mChildren.add(new ACFEE());
        mChildren.add(new ACFEF());
