...
public class ACEB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACEB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACEBB());
        mChildren.add(new ACEBC());
        mChildren.add(new ACEBD());
        mChildren.add(new ACEBE());
        mChildren.add(new ACEBF());
