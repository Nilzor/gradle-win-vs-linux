...
public class AEBF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AEBF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AEBFB());
        mChildren.add(new AEBFC());
        mChildren.add(new AEBFD());
        mChildren.add(new AEBFE());
        mChildren.add(new AEBFF());
