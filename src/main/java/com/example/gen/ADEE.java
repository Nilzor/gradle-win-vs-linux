...
public class ADEE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADEE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADEEB());
        mChildren.add(new ADEEC());
        mChildren.add(new ADEED());
        mChildren.add(new ADEEE());
        mChildren.add(new ADEEF());
