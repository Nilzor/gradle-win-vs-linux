...
public class ACDE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACDE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACDEB());
        mChildren.add(new ACDEC());
        mChildren.add(new ACDED());
        mChildren.add(new ACDEE());
        mChildren.add(new ACDEF());
