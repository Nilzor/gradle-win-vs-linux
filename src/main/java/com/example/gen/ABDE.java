...
public class ABDE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABDE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABDEB());
        mChildren.add(new ABDEC());
        mChildren.add(new ABDED());
        mChildren.add(new ABDEE());
        mChildren.add(new ABDEF());
