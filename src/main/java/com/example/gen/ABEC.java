...
public class ABEC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABEC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABECB());
        mChildren.add(new ABECC());
        mChildren.add(new ABECD());
        mChildren.add(new ABECE());
        mChildren.add(new ABECF());
