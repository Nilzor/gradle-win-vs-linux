...
public class AFDD implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFDD() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFDDB());
        mChildren.add(new AFDDC());
        mChildren.add(new AFDDD());
        mChildren.add(new AFDDE());
        mChildren.add(new AFDDF());
