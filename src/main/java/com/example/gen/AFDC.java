...
public class AFDC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFDC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFDCB());
        mChildren.add(new AFDCC());
        mChildren.add(new AFDCD());
        mChildren.add(new AFDCE());
        mChildren.add(new AFDCF());
