...
public class AFEC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFEC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFECB());
        mChildren.add(new AFECC());
        mChildren.add(new AFECD());
        mChildren.add(new AFECE());
        mChildren.add(new AFECF());
