...
public class AFC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFCB());
        mChildren.add(new AFCC());
        mChildren.add(new AFCD());
        mChildren.add(new AFCE());
        mChildren.add(new AFCF());
