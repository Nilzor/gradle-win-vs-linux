...
public class ACE implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACE() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACEB());
        mChildren.add(new ACEC());
        mChildren.add(new ACED());
        mChildren.add(new ACEE());
        mChildren.add(new ACEF());
