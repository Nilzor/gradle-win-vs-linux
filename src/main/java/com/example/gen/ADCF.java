...
public class ADCF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADCF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADCFB());
        mChildren.add(new ADCFC());
        mChildren.add(new ADCFD());
        mChildren.add(new ADCFE());
        mChildren.add(new ADCFF());
