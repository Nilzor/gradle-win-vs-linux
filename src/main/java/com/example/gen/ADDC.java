...
public class ADDC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADDC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADDCB());
        mChildren.add(new ADDCC());
        mChildren.add(new ADDCD());
        mChildren.add(new ADDCE());
        mChildren.add(new ADDCF());
