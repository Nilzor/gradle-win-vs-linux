...
public class ADFB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADFB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADFBB());
        mChildren.add(new ADFBC());
        mChildren.add(new ADFBD());
        mChildren.add(new ADFBE());
        mChildren.add(new ADFBF());
