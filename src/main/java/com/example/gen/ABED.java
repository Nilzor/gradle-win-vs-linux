...
public class ABED implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ABED() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ABEDB());
        mChildren.add(new ABEDC());
        mChildren.add(new ABEDD());
        mChildren.add(new ABEDE());
        mChildren.add(new ABEDF());
