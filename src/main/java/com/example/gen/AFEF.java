...
public class AFEF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFEF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFEFB());
        mChildren.add(new AFEFC());
        mChildren.add(new AFEFD());
        mChildren.add(new AFEFE());
        mChildren.add(new AFEFF());
