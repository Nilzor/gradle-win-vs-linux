...
public class ACEC implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACEC() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACECB());
        mChildren.add(new ACECC());
        mChildren.add(new ACECD());
        mChildren.add(new ACECE());
        mChildren.add(new ACECF());
