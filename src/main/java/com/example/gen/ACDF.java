...
public class ACDF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ACDF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ACDFB());
        mChildren.add(new ACDFC());
        mChildren.add(new ACDFD());
        mChildren.add(new ACDFE());
        mChildren.add(new ACDFF());
