...
public class AFF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFFB());
        mChildren.add(new AFFC());
        mChildren.add(new AFFD());
        mChildren.add(new AFFE());
        mChildren.add(new AFFF());
