...
public class ADDF implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public ADDF() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new ADDFB());
        mChildren.add(new ADDFC());
        mChildren.add(new ADDFD());
        mChildren.add(new ADDFE());
        mChildren.add(new ADDFF());
