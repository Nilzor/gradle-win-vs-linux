...
public class AEBB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AEBB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AEBBB());
        mChildren.add(new AEBBC());
        mChildren.add(new AEBBD());
        mChildren.add(new AEBBE());
        mChildren.add(new AEBBF());
