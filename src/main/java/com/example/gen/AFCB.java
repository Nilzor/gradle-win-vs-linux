...
public class AFCB implements ResultProvider {
    ArrayList<ResultProvider> mChildren;
    private static final int CHILD_COUNT = 5;

    public AFCB() {
        mChildren = new ArrayList<>(CHILD_COUNT);
        mChildren.add(new AFCBB());
        mChildren.add(new AFCBC());
        mChildren.add(new AFCBD());
        mChildren.add(new AFCBE());
        mChildren.add(new AFCBF());
